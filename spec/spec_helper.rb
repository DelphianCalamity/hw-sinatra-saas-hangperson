...
def stub_random_word(word)
  stub_request(:get, 'https://random-word-api.herokuapp.com/word').to_return(:body => word)
end
...
RSpec.configure do |config|
  ...
  config.before(:each) do
    stub_request(:get, "https://random-word-api.herokuapp.com/word").to_return(:body => "foobar")
  end
  config.color = true
